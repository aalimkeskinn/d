...
import { Calendar, LogOut, Eye, Menu, X, GraduationCap, Home, ChevronRight, Zap, Database } from 'lucide-react';
        ...
        <div className="relative p-6 bg-gradient-to-br from-ide-primary-600 via-ide-primary-700 to-ide-primary-800 border-b border-ide-primary-500">
          ...
          <div className="relative z-10 flex items-center justify-between lg:justify-start">
            <div className="flex items-center space-x-4">
              ...
              {/* Title */}
              <div>
                <h1 className="text-xl font-semibold text-white leading-tight">ide okulları</h1>
          ...
          <div className="space-y-2">
            {navItems.map(({ to, icon: Icon, label, description }) => (
              <NavLink
                ...
                onClick={closeMobileMenu}
                className={({ isActive }) =>
                  `group relative flex items-center p-4 rounded-xl transition-all duration-300 ${isActive
                  ...
                  <>
                    ...
                    <div className="flex-1 ml-4 min-w-0">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className={`font-semibold text-base leading-tight transition-colors duration-300 ${isActive ? 'text-ide-primary-700' : 'text-gray-900 group-hover:text-ide-primary-600'
                            }`}>
                            {label}
                          </p>
                          <p className={`text-sm mt-1 transition-colors duration-300 ${isActive ? 'text-ide-primary-600' : 'text-gray-500 group-hover:text-ide-primary-500'
                            }`}>
                            {description}
                          </p>
                        </div>
