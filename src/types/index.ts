...
export interface Teacher {
  ...
  isClubTeacher?: boolean; // YENİ: Kulüp öğretmeni mi?
  createdAt: Date;
}
...
export interface Subject {
  ...
  levels?: ('Anaokulu' | 'İlkokul' | 'Ortaokul')[];
  weeklyHours: number;
  distributionPattern?: string | null; // YENİ: Dağıtım şekli (örn: "2+2+2")
  className?: string; // YENİ: Dersin ait olduğu sınıf adı
  createdAt: Date;
}
...
export interface Class {
  ...
  levels?: ('Anaokulu' | 'İlkokul' | 'Ortaokul')[];
  createdAt: Date;
  classTeacherId?: string | null; // Sınıf öğretmeni ID'si (opsiyonel)
  ...
  isClubClass?: boolean; // YENİ: Kulüp sınıfı mı?
  teacherIds?: string[];
}
...
export interface ScheduleSlot {
  ...
  teacherId?: string;
  isFixed?: boolean;
  isFixedSlot?: boolean; // YENİ: Sabit ders yerleştirme için
}
...
export const PRIMARY_SCHOOL_TIME_PERIODS: TimePeriod[] = [
  { period: 'prep', startTime: '08:30', endTime: '08:50', isBreak: true }, // Kahvaltı
  ...
  { period: '5', startTime: '11:50', endTime: '12:25', isBreak: true }, // Yemek (İlkokul için)
...
export const MIDDLE_SCHOOL_TIME_PERIODS: TimePeriod[] = [
  { period: 'prep', startTime: '08:30', endTime: '08:40', isBreak: true }, // Hazırlık
  { period: '1', startTime: '08:40', endTime: '09:15' },
  { period: 'break-after-1', startTime: '09:15', endTime: '09:35', isBreak: true }, // Kahvaltı (Ortaokul için)
  { period: '2', startTime: '09:35', endTime: '10:10' },
  { period: '3', startTime: '10:20', endTime: '10:55' },
  { period: '4', startTime: '11:05', endTime: '11:40' },
  { period: '5', startTime: '11:50', endTime: '12:25' },
  { period: '6', startTime: '12:30', endTime: '13:05', isBreak: true }, // Yemek (Ortaokul için)
  { period: '7', startTime: '13:15', endTime: '13:50' },
  { period: '8', startTime: '14:00', endTime: '14:35' },
  { period: 'afternoon-breakfast', startTime: '14:35', endTime: '14:45', isBreak: true },
  { period: '9', startTime: '14:45', endTime: '15:20' },
...
export const generateDistributionSuggestions = (totalHours: number): string[] => {
  ...
  return Array.from(new Set(suggestions)); // Tekrarları kaldır
};
